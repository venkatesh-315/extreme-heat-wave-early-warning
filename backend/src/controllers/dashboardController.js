  ...
  try {
    ...
    return successResponse(
      res,
      {
        ...
        dataStatus: {
          weather: 'LIVE',
          weatherSource: weatherResult?.source || 'Open-Meteo High-Resolution WMO Grid',
          healthDataStatus: 'UNAVAILABLE',
          healthDataSource: 'Integrated Disease Surveillance Programme (IDSP) / NDMA HAP Reports',
          healthDataNote: 'Official real-time health APIs do not exist. Displaying model-estimated physiological risks only.',
          modelVersion: 'v1.0.0',
          featureSchemaVersion: 'v1.0.0',
        },
